...
export const gameConfig = { 
   'ssc':[
      ...
      HousanzhixuanhezhiComponent,HousanzhixuankuaduComponent,HousanzhixuanzuheComponent,ErxingzhixuanhouerhezhiComponent,ErxingzhixuanhouerfushiComponent,HousanzusanComponent,
