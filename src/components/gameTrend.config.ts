...
export const trendAll = {
    ...
    'Xuan5':{
       'WuxingComponent':["三码前三直选复式", "二码前二直选复式"],
       'ZufuComponent':["三码前三组选复式", "二码前二组选复式", "三码前三组选胆拖"]
    }  
}
...
function getWei(gameMethod){
    ...
    else if(["前三直选复式","前三直选组合","三码前三直选复式"].indexOf(gameMethod) != -1)
    ...
    else if(["三码前三组选复式","三码前三组选胆拖","二码前二组选复式"].indexOf(gameMethod) != -1)
        return ['开奖','走势']
...
function getPosition(gameMethod){
      if(["三码前三直选复式","三码前三组选复式","三码前三组选胆拖","前三直选和值","前三组选和值","前三直选跨度","前三组三","前三组六","前三包胆","前三和值尾数","前三特殊号码","不定位前三一码不定位","不定位前三二码不定位","大小单双前三大小单双"].indexOf(gameMethod) != -1)
         return [0,3]
         ...
         return [0,2]
      else if(["不定位四星一码不定位","不定位四星二码不定位","四星直选复式"].indexOf(gameMethod) != -1)
         return [1,5]
      else if(["五星直选复式","不定位五星二码不定位" , "不定位五星三码不定位"].indexOf(gameMethod) != -1)
         return [0,5]  
}
