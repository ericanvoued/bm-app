...
export const trendAll = {
    ...
    'Xuan5':{
       ...
       'ZufuComponent':["三码前三组选复式", "二码前二组选复式", "三码前三组选胆拖","不定位前三不定位","任选复式任选一中一复式","任选复式任选二中二复式","任选复式任选三中三复式","任选复式任选四中四复式","任选复式任选五中五复式",
...
function getWei(gameMethod){
    ...
    else if(["三码前三组选复式","三码前三组选胆拖","二码前二组选复式","任选复式任选一中一复式","不定位前三不定位","任选复式任选二中二复式","任选复式任选三中三复式","任选复式任选四中四复式","任选复式任选五中五复式",
             "任选复式任选六中五复式","任选复式任选七中五复式","任选复式任选八中五复式","任选胆拖任选二中二胆拖","任选胆拖任选三中三胆拖","任选胆拖任选四中四胆拖","任选胆拖任选五中五胆拖",
    ...
    else if(["不定位五星二码不定位" , "不定位五星三码不定位"].indexOf(gameMethod) != -1) 
        return ['和值','跨度','大小比','奇偶比']   
   }

function getPosition(gameMethod){
      if(["三码前三直选复式","三码前三组选复式","三码前三组选胆拖","不定位前三不定位","定位胆定位胆","前三直选和值","前三直选复式","前三组选和值","前三直选跨度","前三组三","前三组六","前三包胆","前三和值尾数","前三特殊号码","不定位前三一码不定位","不定位前三二码不定位","大小单双前三大小单双"].indexOf(gameMethod) != -1)
         return [0,3]
      else if(["中三直选和值","中三组选和值","中三直选跨度","中三直选复式","中三组三","中三组六","中三包胆","中三和值尾数","中三特殊号码","不定位中三一码不定位","不定位中三二码不定位","大小单双中三大小单双"].indexOf(gameMethod) != -1)
         return [1,4]
         ...
         return [3,5]
      else if(["二码前二直选复式","二码前二组选复式","二星前二和值","二星前二跨度","二星前二包胆","大小单双前二大小单双"].indexOf(gameMethod) != -1)
         return [0,2]
      else if(["不定位四星一码不定位","不定位四星二码不定位","四星直选复式","四星直选组合","四星组选24","四星组选12","四星组选6","四星组选4"].indexOf(gameMethod) != -1)
         return [1,5]
      else if(["五星直选复式","一星定位胆","不定位五星二码不定位" , "不定位五星三码不定位", "任选复式任选一中一复式",,"任选复式任选二中二复式","任选复式任选三中三复式","任选复式任选四中四复式","任选复式任选五中五复式",
        "任选复式任选六中五复式","任选复式任选七中五复式","任选复式任选八中五复式","任选胆拖任选二中二胆拖","任选胆拖任选三中三胆拖","任选胆拖任选四中四胆拖","任选胆拖任选五中五胆拖",
      "任选胆拖任选六中五胆拖","任选胆拖任选七中五胆拖","任选胆拖任选八中五胆拖"].indexOf(gameMethod) != -1)
         return [0,5]  
}
